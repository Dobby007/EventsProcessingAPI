...
namespace EventsChart.Rendering
{
    readonly struct RenderingRequest
    {
        ...
        public bool Covers(long offset, in SegmentSize segmentSize, int width)
        {
            if (!segmentSize.Equals(SegmentSize))
                return false;
        ...
        public RenderingRequest(long offset, SegmentSize segmentSize, int width)
        {
            Offset = offset;
